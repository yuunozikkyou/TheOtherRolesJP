...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static CustomOption homeguardSpawnRate;
        public static CustomOption homeguardTasks0;
        ...
        public static void Load() {
            ...
            activateRoles = CustomOption.Create(1, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "モッドロールを有効にし、バニラロールをブロックする"), true, null, true);
            anyPlayerCanStopStart = CustomOption.Create(2, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "誰でもスタートを止めることができる"), false, null, false);
            ...
            crewmateRolesCountMin = CustomOption.Create(300, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最小クルー役職数"), 15f, 0f, 15f, 1f, null, true);
